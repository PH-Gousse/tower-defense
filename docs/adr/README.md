...
| [0019](0019-lane-is-16-wide-with-2x2-towers-and-1-tile-creeps.md) | The lane is 16 wide and Warcraft 3-length, towers are 2×2, creeps are 1×1 | Accepted — **not implemented** |
| [0020](0020-towers-anchor-on-the-creep-tile-grid.md) | Towers anchor on the 1-tile creep grid | Accepted — **not implemented** |
| [0021](0021-creeps-do-not-collide.md) | Creeps do not collide with each other | Accepted |
| [0022](0022-spawns-spread-across-the-zone-with-a-fractional-setback.md) | Spawns spread across the zone and keep the fractional setback | Accepted — **not implemented** |
| [0023](0023-placement-on-a-creep-is-refused.md) | A placement whose footprint holds a creep is refused | Accepted — **not implemented**; supersedes half of ADR-0012 |
